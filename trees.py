...
def createDataSet():
    ...
    labels = ['cartoon', 'winter', 'more than 1 person','tomar']
...
print("--Test casos particulares--- ")

#run test

# test with winter family photo
answer = classify(mytree, ['cartoon', 'winter', 'more than 1 person'], [8, 2, 1])
print("respuesta entrada [8, 2, 1]: "+ str(answer))

# test with cartoon characters winter pictures
answer = classify(mytree, ['cartoon', 'winter', 'more than 1 person'], [0, 1, 0])
print("respuesta entrada [0, 1, 0]: "+ str(answer))

answer = classify(mytree, ['cartoon', 'winter', 'more than 1 person'], [1, 0, 1])
print("respuesta entrada [1, 0, 1]: "+ str(answer))

answer = classify(mytree, ['cartoon', 'winter', 'more than 1 person'], [1, 1, 1])
print("respuesta entrada [1, 1, 1]: "+ str(answer))
